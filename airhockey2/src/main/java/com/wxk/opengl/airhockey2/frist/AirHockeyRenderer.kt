package com.wxk.opengl.airhockey2.frist

import android.content.Context
import android.opengl.GLES10
import android.opengl.GLES20.*
import android.opengl.GLSurfaceView
import com.wxk.opengl.airhockey2.R
...
class AirHockeyRenderer(private val context: Context) : GLSurfaceView.Renderer {
    ...
    private val tableVerticesWithTriangles = floatArrayOf(
        ...
        //坐标颜色点规则： x,y,r,g,b
        0f, 0f,          1f, 1f, 1f,        //a点
        -0.5f, -0.5f,    0.7f, 0.7f, 0.7f,  //b点
        0.5f, -0.5f,     0.7f, 0.7f, 0.7f,  //c点
        0.5f, 0.5f,      0.7f, 0.7f, 0.7f,  //d点
        -0.5f, 0.5f,     0.7f, 0.7f, 0.7f,  //e点
        -0.5f, -0.5f,    0.7f, 0.7f, 0.7f,  //f点
        //线条 1
        -0.5f, 0f,       1f, 0f, 0f,
        0.5f, 0f,        1f, 0f, 0f,
        //木槌坐标
